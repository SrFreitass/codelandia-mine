...
<div style="display: flex; align-items: center; justify-content: center; margin-top: 30px;">
  <div style="text-align: center; margin-right: 50px;">
    ...
    <img src="../assets/Desktop.png" alt="Captura de tela do projeto em execução" width="600">
  </div>
  <div style="text-align: center;">
    <p style="font-weight: bold; margin-bottom: 10px;">📱 Mobile</p>
    <img src="../assets/mobile.png" alt="Captura de tela do projeto em execução" width="200">
  </div>
</div>
